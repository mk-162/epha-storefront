        ...
        <section className="relative overflow-hidden bg-slate-900 py-24 text-white md:py-32">
          ...
          <div className="container relative mx-auto max-w-4xl px-4 text-center">
            ...
            <p className="mx-auto max-w-2xl text-slate-400">
              Every industry faces unique challenges. Extreme temperatures. Harsh chemicals.
              Constant vibration. Abrasive environments. EPHA understands your operational realities
              and delivers protection that performs where you work.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {benefits.map((benefit, idx) => {
                ...
                return (
                  <div
                    className="flex gap-4 rounded-xl border border-white/10 bg-white/5 p-6 transition-colors hover:bg-white/10"
                    key={idx}
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed text-slate-300">{benefit.desc}</p>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="flex flex-col rounded-2xl border border-slate-100 bg-white p-8 shadow-sm">
                <blockquote className="mb-6 flex-1 italic text-slate-600">
                  &quot;We&apos;ve reduced hydraulic line failures by 85% since implementing EPHA
                  protectors across our 200-vehicle fleet. The ROI was immediate.&quot;
                </blockquote>
              ...
              <div className="flex flex-col rounded-2xl border border-slate-100 bg-white p-8 shadow-sm">
                <blockquote className="mb-6 flex-1 italic text-slate-600">
                  &quot;In construction, every hour of downtime costs us thousands. EPHA protectors
                  are a no-brainer investment that pays for itself the first time it prevents a hose
                  failure.&quot;
                </blockquote>
                <div className="border-t border-slate-100 pt-4">
              ...
              <div className="flex flex-col rounded-2xl border border-slate-100 bg-white p-8 shadow-sm">
                <blockquote className="mb-6 flex-1 italic text-slate-600">
                  &quot;Our production lines can&apos;t afford unplanned stops. EPHA protection has
                  extended our hydraulic hose life by 4x and virtually eliminated emergency
                  repairs.&quot;
                </blockquote>
                <div className="border-t border-slate-100 pt-4">
